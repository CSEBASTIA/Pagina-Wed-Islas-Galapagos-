// js/components/tours.ui.js  — Strategy Pattern para filtrado de tours
...
class PriceFilterStrategy {
    ...
    async apply(tours) { return [...tours].sort((a, b) => a.price - b.price); }
}
...
const ToursUI = {
    ...
    createTourCard(tour) {
        ...
        // Escapar el título para usarlo en el onclick sin romper las comillas
        const safeName = (tour.title || '').replace(/\\/g, '\\\\').replace(/'/g, "\\'");
        ...
        card.innerHTML = `
            ...
            <div class="p-6 flex-1 flex flex-col">
                ...
                <div class="mt-auto pt-4 border-t border-gray-100">
                    <button onclick="ReviewModal.open('${safeName}', ${tour.id})"
